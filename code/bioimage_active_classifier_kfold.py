...
def main(params):
    ...
    for split_num in range(0,6):
        data_train, data_test, labels_train, labels_expected = \
            train_test_split(all_data, all_labels, test_size=0.33)
        ...
        img_name = output_fig.split('.')
        plot_figures(a_test_error, r_test_error, batch_array, min_cost, min_test_error, img_name[0]+'_'+str(split_num)+'_.'+img_name[1])
...
if __name__ =="__main__":
    ...
    parser.add_argument('--calls_to_oracle', dest='calls_to_oracle', type=int, default=300)
